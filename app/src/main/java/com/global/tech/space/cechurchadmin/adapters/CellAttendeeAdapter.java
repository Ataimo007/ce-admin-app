...
import static com.global.tech.space.cechurchadmin.adapters.CellAttendeeAdapter.AttendeeHolder;

public class CellAttendeeAdapter extends RecyclerView.Adapter<AttendeeHolder>
{
    private final int[] avatars = { R.drawable.avatar_1, R.drawable.avatar_2, R.drawable.avatar_3, R.drawable.avatar_4 };
    private final Random random = new Random();

    private final List<CellAttendee> attendees;
    private AppCompatActivity context = null;

    public CellAttendeeAdapter(AppCompatActivity context, List<CellAttendee> attendees ) {
